...
- patterns for building cloud native applications and best practices for common tasks such as messaging, eventing, and DevOps.

- architectural building blocks for a modern cloud native application. 
- how to use microservices, containers, serverless computing, storage types, portability, and functions. 
- fundamentals of cloud native applications,  how to design, develop, and operate them.
...
- Techniques, and best practices for building and managing cloud native applications
